      ...
      <header className="absolute inset-x-0 top-0 ">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
             ...
             <h2 className="text-black text-2xl ">EventSpot Lite</h2>
            </a>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden" role="dialog" aria-modal="true">
            <div className="fixed inset-0 z-50 bg-black opacity-25" onClick={() => setMobileMenuOpen(false)}></div>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Turning visions into experiences—join us for expertly crafted events that leave a lasting impression.
            </p>
        ...
        <div className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-44rem)]" aria-hidden="true">
          <div
